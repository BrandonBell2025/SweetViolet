...
try:
    client = MongoClient("mongodb+srv://Allen:yeet@sweet-violet-database.7mf4d.mongodb.net/?retryWrites=true&w=majority&appName=Sweet-Violet-Database")  # Replace with your MongoDB URI
